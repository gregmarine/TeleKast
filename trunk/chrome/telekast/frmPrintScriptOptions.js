...
// Actions to perform if user clicks OK
function OnDialogAccept()
{
    opener.ShowPrintScriptDialog(Element("chkCameraCue").checked, Element("chkAudioCue").checked, Element("chkVideoCue").checked, Element("chkTalentCue").checked, Element("chkOtherCue").checked);
}
